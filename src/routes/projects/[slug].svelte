...
<script>
  export /**
* @type {{ name: any; image: { url: string | null | undefined; }[]; title: string | null | undefined; tags: any; demo: string | null | undefined; sourceCode: string | null | undefined; description: any; }}
*/
   let project
</script>
